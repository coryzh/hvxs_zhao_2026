...
def rename_distance_cols(verbose: bool = False) -> None:
    """
    A routine used for renaming distance columns in the master catalogues.
    Master catalogues generated by manipulation.make_master() are results of
    merging X-ray, Gaia, and kinematics catalogues, and since March 20, 2025
    Bailer-Jones distances are used for kinematic computation. So the resulting
    column names follow their naming.
    Parameters
    ----------
    verbose : bool, optional
        If True, more information is printed; by default False.
    """
