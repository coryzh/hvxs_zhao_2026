...
class CombinedCatalogueSchema(Schema):
    ID_x: str = "ID_x"
    ra_x: str = "ra_x"
    dec_x: str = "dec_x"
    pos_x_err: str = "pos_x_err"
    source_id: str = "source_id"
    ra_gaia: str = "ra_gaia"
    ...
    non_single_star: str = "non_single_star"
    mh_gspphot: str = "mh_gspphot"
    mh_gspphot_lower: str = "mh_gspphot_lower"
    mh_gspphot_upper: str = "mh_gspphot_upper"
    parallax: str = "parallax"
    parallax_corr: str = "parallax_corr"
    parallax_error: str = "parallax_error"
    pmra: str = "pmra"
    ...
    pmdec: str = "pmdec"
    pmdec_error: str = "pmdec_error"
    dist_med: str = "dist_med"
    e_dist: str = "e_dist"
    E_dist: str = "E_dist"
    vpec_gamma_min_med: str = "vpec_gamma_min_med"
    e_vpec_gamma_min: str = "e_vpec_gamma_min"
    E_vpec_gamma_min: str = "E_vpec_gamma_min"
    vpec_min_med: str = "vpec_min_med"
    e_vpec_min: str = "e_vpec_min"
    E_vpec_min: str = "E_vpec_min"
    vspace_gamma_min_med: str = "vspace_gamma_min_med"
    e_vspace_gamma_min: str = "e_vspace_gamma_min"
    E_vspace_gamma_min: str = "E_vspace_gamma_min"
    vspace_min_med: str = "vspace_min_med"
    e_vspace_min: str = "e_vspace_min"
    E_vspace_min: str = "E_vspace_min"
    phot_g_mean_mag: str = "phot_g_mean_mag"
    phot_rp_mean_mag: str = "phot_rp_mean_mag"
    phot_bp_mean_mag: str = "phot_bp_mean_mag"
